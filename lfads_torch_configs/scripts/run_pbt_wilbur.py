...
# ---------- OPTIONS ----------
PROJECT_STR = f"wilbur_{run_idx}"
DATASET_STR = f"TORCH_wilbur20210407_wake_chopped_0.1xcorr_10ms"
RUN_TAG = datetime.now().strftime("%y%m%d") + f"_wilbur_PBT"
...
HYPERPARAM_SPACE = {
    ...
    "model.kl_co_scale": HyperParam(1e-7, 1e-4, explore_wt=0.8),
    "model.kl_ic_scale": HyperParam(1e-7, 1e-4, explore_wt=0.8),
    "model.l2_gen_scale": HyperParam(1e-7, 1e-0, explore_wt=0.8),
    "model.l2_con_scale": HyperParam(1e-7, 1e-0, explore_wt=0.8),
}
# ------------------------------
